        ...
        body = f"""
            <html>
              <body style=\"font-family: Arial, sans-serif; line-height: 1.6; color: #333;\">
                ...
                <p style=\"background: #f63131; color: #fff; padding: 12px 18px; border-radius: 6px; font-weight: bold; text-align: center;\">Your feedback is invaluable to us as we strive to make each year even better. Please take a moment to let us know about your experience:</p>
